...
class Tegning extends JPanel {
    public void paintComponent(Graphics smiley) {
        ...
        Color øyne = new Color(150, 255, 230);
        ...
        // Øyenbryn
        // plassering fra venstre, plassering fra topp, bredde, høyde, startvinkel(0 er
        // rett høyre), sluttvinkel (fra startpunkt)
        smiley.drawArc(760, 445, 100, 50, 50, 50);
