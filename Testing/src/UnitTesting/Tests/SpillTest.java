...
import UnitTesting.Classes.Spill;
import UnitTesting.Classes.Spiller;
...
class SpillTest {
    ...
    public void testBeregnPoeng() throws Exception {
        ...
        if (spiller1.getBokstav() < spiller2.getBokstav())
            spiller1Poeng++;
        else if (spiller1.getBokstav() > spiller2.getBokstav())
            spiller2Poeng++;
        boolean expResult = true;
    ...
    /*
     * Test of spillMangeOmganger method, of class Spill. Exception forventes å
     * kastes pga av en omgang for mye
     */
    @Test
    ...
    public void testAvsluttSpill() throws Exception {
        ...
        if (spiller1.getAntallPoeng() > spiller2.getAntallPoeng())
            expResult = spiller1.getNavn() + " vant:)";
        else if (spiller2.getAntallPoeng() > spiller1.getAntallPoeng())
            expResult = spiller2.getNavn() + " vant:)";
