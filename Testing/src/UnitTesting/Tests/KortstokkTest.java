...
import UnitTesting.Classes.Kortstokk;
...
class KortstokkTest {
    ...
    @Test
    public void testGetKortstokk() { // test om kortstokken inneholder alle bokstavene i alfabetet, og ingen
                                     // duplikater
    ...
    @Test
    public void testGetKort_normalsituasjon() throws Exception { // tester at etter ett tall er trukket så er
                                                                 // arraylisten med kort minket med 1
    ...
    public void testGetKort_tomkortstokk() throws Exception {
        ...
        instance.getAntallBokstaver();
        for (int i = forsteBokstav; i <= sisteBokstav; i++) {
            instance.getKort();
        }
        // char bokstav = instance.getKort(); // skal kaste unntak, kortstokken er nå
        // tom
